package it.universita.dbinterface;
...
public class DbConnection {
   ...
   public static DbConnection getInstance() {
	   ...
	   if(connesso != true)
			connetti("universita", "root", "zuppetto19");
	   return instance;
   }
   ...
   public ArrayList<String[]> eseguiQuery(String query) {      //una singola riga è rappres come un array di stringhe->non so quante colonne ho
